...
import logo from "../assets/bookofsat-removebg-preview.png";

const Hero = () => {
  return (
    <section className="w-full py-32">
      <div className="container grid items-center justify-between grid-cols-1 lg:grid-cols-2 gap-y-16">
        <article className="flex flex-col gap-5">
          ...
          Jump on board with $BSC (Book of Satoshi Coin) now and unlock the potential for substantial market gains. Earn BTC rewards while investing in a project with promising growth prospects. Don't miss out on your chance to ride the wave to financial success.
          </p>
          <div className="inline-flex items-start justify-start gap-5 font-goodGame">
            <a
              href=""
            ...
            >
              <div className="text-base font-normal leading-snug tracking-tight text-zinc-900">
                BUY ON PANCAKESWAP
              </div>
            </a>
            <a
          ...
          <div className="flex items-center gap-5 mt-10">
            <a href="https://t.me/BookofSatoshiCoin">
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
            ...
            <a href="https://twitter.com/BookSatoshiCoin">
              <svg
                width="40"
                height="32"
                viewBox="0 0 40 32"
